...
이를 보정하기 위한 방법으로, covariate을 추가하거나, 모델에 계절성을 추가하는 등의 방식을 생각해볼 수 있다.
...
Covariate의 시계열은 대체로 causal effect가 유의하지 않게, 기대했던대로 얻어진다. 다만, 계절적 요인을 잘 반영하지 못하며, 제한된 수의 covariate 때문에 credible interval이 넓게 추정됨을 볼 수 있다.
